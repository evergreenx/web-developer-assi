...
const NewPostButton: React.FC<NewPostButtonProps> = ({ onClick }) => {
  return (
    <div
      onClick={onClick}
      className="
      border border-border h-[293px] w-[270px] rounded-lg text-foreground flex flex-col items-center justify-center cursor-pointer hover:shadow
      
      border-dashed text-center
       font-semibold text-sm p-6  focus:outline-none focus:shadow-outline"
    >
      <svg
        width="24"
        height="24"
